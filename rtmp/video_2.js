...
var FullscreenToggle = function (_Button) {
  ...
  FullscreenToggle.prototype.handleClick = function handleClick(event) {
    if (!screenfull.isFullscreen) {
        var target = $('#fullscreen-div')[0];
        screenfull.request(target);
        $('#fullscreen-div').css('height','100%');
        $('#fullscreen-div').css('width','100%');
        var windowWidth = $(window).width();
        var windowHeight = $(window).height();
        $("#dm-container").css('height', '100%');
        $("#dm-container").css('width', '100%');
    ...
    if (screenfull.isFullscreen){
        screenfull.exit();
        $('#fullscreen-div').css('height','');
        $('#fullscreen-div').css('width','');
        $("#dm-container").css('height', '450px');
        $("#dm-container").css('width', '800px');
        $("#example_video_1").css('height', '450px');
        $("#example_video_1").css('width', '800px');
